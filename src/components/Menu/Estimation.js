...
function Estimation() {
  return (
    ...
    <InputGroup className="mb-2">
        ...
        <Form.Control aria-label="Text input with radio button" placeholder='5' type="number"/>
        
      </InputGroup>
      <InputGroup className="mb-2">
        <InputGroup.Text >Gaining Factor</InputGroup.Text>
        <Form.Control aria-label="Text input with radio button" placeholder='0.010' type="number"/>
        
      </InputGroup>
      <InputGroup className="mb-2">
        <InputGroup.Text >Multipication Factor</InputGroup.Text>
        <Form.Control aria-label="Text input with radio button" placeholder='10' type="number"/>
        
      </InputGroup>
      <InputGroup className="mb-2">
        <InputGroup.Text >Iterations in phase 3</InputGroup.Text>
        <Form.Control aria-label="Text input with radio button" placeholder='500' type="number"/>
        
      </InputGroup>
      <InputGroup className="mb-2">
        <InputGroup.Text >Max. estimation nuns</InputGroup.Text>
        <Form.Control aria-label="Text input with radio button" placeholder='1' type="number"/>
